...
<?php 
$status=1;
$sql = "SELECT users.full_name,vehicles_list.vehicle_title,booking.from_date,booking.to_date,booking.vehicle_id,booking.id from booking join vehicles_list on vehicles_list.vehicle_id=booking.vehicle_id join users on users.email_id=booking.usr_email where booking.status=:status";
